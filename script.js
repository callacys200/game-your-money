...
const buildings = [
  { name: "Budgeting Basics", img: "house", x: 0.042, y: 0.025, w: 0.23, h: 0.1, link: "localhost:3000"},
  { name: "Saving & Investing", img: "office", x: 0.69, y: 0.21, w: 0.23, h: 0.1, link: "localhost:3000"},
  { name: "Banking Basics", img: "bank", x: 0.01, y: 0.401, w: 0.3, h: 0.09, link: "localhost:3000"},
  { name: "Taxes & Income", img: "atm", x: 0.65, y: 0.6, w: 0.37, h: 0.08, link: "localhost:3000"}
];
